...
数据采集 (data_collect)
    ↓
数据分析 (analysis_timeline / analysis_sentiment)
    ↓
报告生成 (report_html)
    ↓
HTML 报告输出
...
report_html_prompt: report_html.txt
```
...
### 6. report_html（HTML 报告生成）

**功能**：根据分析结果生成美观、交互式的 HTML 舆情分析报告。
