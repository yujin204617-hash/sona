...
class InterpretationOutput:
    ...
    recommendations: Dict[str, Any]  # 新增
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "recommendations": self.recommendations,  # 新增
        }
...
def generate_interpretation(
    ...
    try:
        ...
        recommendations = parsed.get("recommendations", {})  # ← 添加这一行
    except Exception as e:
        return json.dumps(
    ...
    try:
        ...
        output = InterpretationOutput(
            ...
            recommendations=recommendations,  # ← 添加这一行
